...
(function(){
  ...
  bd.innerHTML = `
    <div class="modal">
      <h3>Policy Notice</h3>
      <p>We use cookies to improve your experience. By using our website you are accepting our Cookie Policy. <strong>NeoSpin</strong>. </p>
...
(function(){
  ...
  bd.querySelector('#age-yes').addEventListener('click', 
                                                function(){
    window.location.href = "https://karlose-loki.github.io/neo_spin/"; // change to your target page
  });
